...
Public Class PequeñoSistema


    Private Sub MenuItemNuevo_Click(sender As Object, e As EventArgs) Handles MenuItemNuevo.Click
        ' Crea una nueva instancia del formulario "Pequeño Formulario"
        Dim form As New PequeñoFormulario()
