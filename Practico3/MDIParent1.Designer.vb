...
Partial Class PequeñoSistema
    ...
    Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(PequeñoSistema))
        MenuStrip = New MenuStrip()
        FileMenu = New ToolStripMenuItem()
        MenuItemNuevo = New ToolStripMenuItem()
        ...
        ' FileMenu
        ' 
        FileMenu.DropDownItems.AddRange(New ToolStripItem() {MenuItemNuevo, OpenToolStripMenuItem, ToolStripSeparator3, SaveToolStripMenuItem, SaveAsToolStripMenuItem, ToolStripSeparator4, PrintToolStripMenuItem, PrintPreviewToolStripMenuItem, PrintSetupToolStripMenuItem, ToolStripSeparator5, ExitToolStripMenuItem})
        ...
        ' MenuItemNuevo
        ' 
        MenuItemNuevo.Image = CType(resources.GetObject("MenuItemNuevo.Image"), Image)
        MenuItemNuevo.ImageTransparentColor = Color.Black
        MenuItemNuevo.Name = "MenuItemNuevo"
        MenuItemNuevo.ShortcutKeys = Keys.Control Or Keys.N
        MenuItemNuevo.Size = New Size(206, 22)
        MenuItemNuevo.Text = "&Nuevo"
        ' 
    ...
    Friend WithEvents MenuItemNuevo As System.Windows.Forms.ToolStripMenuItem
